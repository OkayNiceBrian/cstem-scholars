...
if ($currentRole == "admin") {
    ...
    ?>
        <div>
            <a href="?redirect=advisors/applications.php">
                <span style="display: block; padding: 5px; margin-bottom: 5px; border-radius: 5px 5px 5px; border: 1px solid red; background-color: #ffcaca;">
    ...
    ?>
        <div>
            <a href="?redirect=reviewers/applications.php">
                <span style="display: block; padding: 5px; margin-bottom: 5px; border-radius: 5px 5px 5px; border: 1px solid red; background-color: #ffcaca;">
